...
@reboot root sleep 60;rclone mount pikpak: /volume1/DSM/emby/sharep  --allow-non-empty --allow-other --vfs-cache-mode writes --dir-cache-time 25h --buffer-size 0M --vfs-read-chunk-size 128M --vfs-read-chunk-size-limit 1G
```
```
